...
@Injectable()
export class BinanceInstrumentService extends InstrumentServiceBase {
    ...
    constructor(protected _http: HttpClient) {
        ...
        this._endpoint = `${AppConfigService.config.apiUrls.binanceREST}instruments/extended`;
    }
    ...
    protected mapResponse(response, exchange?: EExchange, search?: string): IInstrument[] {
        ...
        try {
            ...
            console.log('Failed to parse Binance API symbols');
            console.log(ex);
        }
