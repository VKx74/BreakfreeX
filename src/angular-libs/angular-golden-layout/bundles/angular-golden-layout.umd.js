(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('angular-golden-layout', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
    (global = global || self, factory(global['angular-golden-layout'] = {}, global.ng.core, global.rxjs, global.rxjs.operators, global.ng.common));
    ...
    ***************************************************************************** */
     ...
     */
    /** @type {?} */
    var GoldenLayoutItemComponentResolver = new core.InjectionToken('GoldenLayoutItemComponentResolver');
    ...
    var PopupWindowManager = /** @class */ (function () {
        function PopupWindowManager(window, popupConfig) {
            ...
            this._runChangeDetection$ = new rxjs.Subject();
     ...
     */
    /** @type {?} */
    var GoldenLayoutItemContainerToken = new core.InjectionToken('wrapper');
     ...
     */
    /** @type {?} */
    var GoldenLayoutComponentConfiguration = new core.InjectionToken('GoldenLayoutComponentConfiguration');
     ...
     */
    /** @type {?} */
    var GoldenLayoutItemState = new core.InjectionToken('GoldenLayoutItemState');
    ...
    /** @type {?} */
    var DefaultLabels = {
        additionalTabs: rxjs.of('Additional tabs'),
        addComponent: rxjs.of('Add Component'),
        maximise: rxjs.of('Maximise'),
        minimise: rxjs.of('Minimise'),
        popout: rxjs.of('Open in new window'),
        popin: rxjs.of('Pop in'),
        close: rxjs.of('Close'),
        loading: rxjs.of('Loading'),
        failedToLoadComponent: rxjs.of('Failed to load component')
    };
    /** @type {?} */
    var Class = {
    ...
    var GoldenLayoutComponent = /** @class */ (function () {
        function GoldenLayoutComponent(viewContainer, _layoutManager, componentFactoryResolver, ngZone, _changeDetectorRef, _appRef, injector, _configuration) {
            ...
            this.$layoutEmpty = new rxjs.BehaviorSubject(false);
        ...
        function () {
            var _this = this;
            this._resize$
                .pipe(operators.auditTime(10), operators.takeUntil(this._destroy$))
                .subscribe((/**
             * @return {?}
             */
            function () {
        ...
        function (stack) {
            ...
            rxjs.fromEvent(popinBtn, 'click').pipe(operators.first()).subscribe((/**
             * @return {?}
             */
            function () {
                var e_3, _a;
        ...
        function (labels) {
            ...
            function (label) {
                 ...
                 * @return {?}
                 */
                function () { return isLayoutInitialized(); })), operators.takeUntil(_this._destroy$));
            });
        ...
        GoldenLayoutComponent.ctorParameters = function () { return [
            ...
            { type: core.Injector },
            { type: undefined, decorators: [{ type: core.Inject, args: [GoldenLayoutComponentConfiguration,] }] }
        ]; };
        GoldenLayoutComponent.propDecorators = {
            el: [{ type: core.ViewChild, args: ['glroot', { static: false },] }],
            onResize: [{ type: core.HostListener, args: ['window:resize', ['$event'],] }],
            unloadNotification: [{ type: core.HostListener, args: ['window:unload', ['$event'],] }]
        };
    ...
    var __Holder = /** @class */ (function () {
        ...
        __Holder.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.SkipSelf }, { type: core.Inject, args: [GoldenLayoutComponentConfiguration,] }] }
        ]; };
        return __Holder;
    }());
    if (false) {
    ...
    var GoldenLayoutPopupComponent = /** @class */ (function () {
        ...
        GoldenLayoutPopupComponent.propDecorators = {
            layout: [{ type: core.ViewChild, args: [GoldenLayoutComponent, { static: false },] }]
        };
    ...
    var GoldenLayoutItemContainerComponent = /** @class */ (function (_super) {
        ...
        function () {
            ...
            if (((/** @type {?} */ (this._componentResolver))).factory != null) {
                ...
                ((/** @type {?} */ (this._componentResolver))).factory()
                     ...
                     */
                    function (factory) {
                        _this.setTitle(rxjs.of(_this._componentResolver.componentName));
                        /** @type {?} */
                ...
                this.setTitle(rxjs.of(this._componentResolver.componentName));
                /** @type {?} */
        ...
        GoldenLayoutItemContainerComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: [GoldenLayoutItemComponentResolver,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [GoldenLayoutComponentConfiguration,] }] },
            { type: core.ComponentFactoryResolver },
            { type: core.Injector }
        ]; };
    ...
    exports.GoldenLayoutComponentConfiguration = GoldenLayoutComponentConfiguration;
    exports.GoldenLayoutItem = GoldenLayoutItem;
    exports.GoldenLayoutItemState = GoldenLayoutItemState;
    exports.GoldenLayoutModule = GoldenLayoutModule;
    exports.GoldenLayoutPopupComponent = GoldenLayoutPopupComponent;
    exports.LayoutManagerService = LayoutManagerService;
    exports.__Holder = __Holder;
    exports.configurationFactory = configurationFactory;
    exports.ɵa = GoldenLayoutItemContainerComponent;
    exports.ɵb = GoldenLayoutContainer;
    exports.ɵc = GoldenLayoutItemComponentResolver;
    exports.ɵd = GoldenLayoutItemContainerToken;
