...
(window as any).__zone_symbol__BLACK_LISTED_EVENTS = ['scroll', 'mousemove', 'mouseleave', 'mouseover', 'mouseout', 'focus', 'mouseenter', 'message']; // disable patch specified eventNames
/*
