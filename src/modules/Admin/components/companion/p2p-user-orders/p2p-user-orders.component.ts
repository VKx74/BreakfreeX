...
@Component({
    selector: 'p2p-user-orders',
    templateUrl: './p2p-user-orders.component.html',
    styleUrls: ['./p2p-user-orders.component.scss']
})
export class P2PUserOrdersComponent extends PaginationComponent<IP2POrderResponse> {
    @Input() id: number;
    @Input() wallet: string;
    ...
    getItems(): Observable<IPaginationResponse<IP2POrderResponse>> {
        ...
        return this._p2pService.getP2PUserOrders(this.paginationParams, this.filtrationParams.toObject());
    }
