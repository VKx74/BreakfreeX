...
@Component({
    selector: 'p2p-accounts',
    templateUrl: './p2p-accounts.component.html',
    styleUrls: ['./p2p-accounts.component.scss']
})
export class P2PAccountsComponent extends PaginationComponent<IP2PUserResponse> implements OnInit {
    loading = false;
    ...
    getItems(): Observable<IPaginationResponse<IP2PUserResponse>> {
        return this._p2pService.getP2PAccounts(this.paginationParams, this.filtrationParams.toObject());
    }
