...
@Component({
    selector: 'p2p-user-historical-ads',
    templateUrl: './p2p-user-historical-ads.component.html',
    styleUrls: ['./p2p-user-historical-ads.component.scss']
})
export class P2PUserHistoricalAdsComponent extends PaginationComponent<IP2PAdResponse> {
    @Input() id: number;
    @Input() wallet: string;
    ...
    getItems(): Observable<IPaginationResponse<IP2PAdResponse>> {
        ...
        return this._p2pService.getP2PUserAdsHistory(this.paginationParams, this.filtrationParams.toObject());
    }
