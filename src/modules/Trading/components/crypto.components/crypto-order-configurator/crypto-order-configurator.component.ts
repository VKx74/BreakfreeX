...
export type OrderConfiguratorSubmitHandler = (config: OrderConfig) => void;

@Component({
    selector: 'crypto-order-configurator',
    templateUrl: './crypto-order-configurator.component.html',
    styleUrls: ['./crypto-order-configurator.component.scss'],
    providers: [
        {
...
export class CryptoOrderConfiguratorComponent implements OnInit {
    @Input()
    ...
    @Input() skipOrderPlacing: boolean;
