...
import {ComplexHistoryService} from "./trends-dataservice/complex-history-dataservice";
import {CandleDto, ComplexHistoryDto, ExchangeHistoryDto} from "./trends-dataservice/common";
...
export class TrendsComponent {
    ...
    private loadData(granularities: Array<number>): void {
        ...
        this._historyService.getData(this.SearchSymbol, this._barscount, granularities)
            .subscribe(
                data => {
                    this.mapResponseResult(data);
                },
                error => {
                    this.trendItemsArray = [];
    ...
    private mapResponseResult(complexHistorydata: ComplexHistoryDto): void {
        ...
        complexHistorydata.HistoryData.forEach(item => {
            ...
            this.trendItemsArray = Array.from(this.TrendItemsMap);
